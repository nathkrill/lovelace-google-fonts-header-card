...
export class GoogleFontsCard extends LitElement {
  ...
  firstUpdated(changeProperties: PropertyValues) {
    ...
    console.log('GFONTSHEADER: FIRST UPDATED')
  ...
  protected render(): TemplateResult | void {
    ...
    return html`
      <div class='header'>
        <h1 style='--g-head-title-font-size: ${this.config.size ? this.config.size : null}; --g-head-title-font-weight: ${this.config.weight ? this.config.weight : null}; --g-head-title-font-weight: ${this.config.weight ? this.config.weight : null};'>
  ...
  static get styles(): CSSResultGroup {
    return css`
      ...
      .header {
          padding: var(--g-head-title-padding, 24px 12px 16px)
      }
      .header * {
          margin: 0px;
